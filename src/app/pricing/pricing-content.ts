...
export const pricingContent: Record<Lang, PricingContent> = {
  en: {
    ...
    s3_1: "$1,000 deposit → $1,000/mo x 4",
    s3_2: "$1,500 deposit → $1,500/mo x 3",
    s3_3: "$2,500 deposit → $2,500/mo x 1",
    ...
    ex1: "$1,500 deposit → $1,500/mo x 12",
    ex2: "$2,000 deposit → $2,000/mo x 9",
    ex3: "$3,000 deposit → $3,000/mo x 6",
    ...
    depHint: "This is due before work begins",
  ...
  es: {
    ...
    s3_1: "$1,000 depósito → $1,000/mes x 4",
    s3_2: "$1,500 depósito → $1,500/mes x 3",
    s3_3: "$2,500 depósito → $2,500/mes x 1",
    ...
    ex1: "$1,500 depósito → $1,500/mes x 12",
    ex2: "$2,000 depósito → $2,000/mes x 9",
    ex3: "$3,000 depósito → $3,000/mes x 6",
    ...
    depHint: "Se paga antes de que comience el trabajo",
